...
Make sure the first user on each computer has the same name. We'll will call this user MAIN_USER from now on. Each computer will be called node0, node1, etc.
